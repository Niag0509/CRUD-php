...
<body style="background-color:#017EA1">
            ...
            <div class="col-sm-12">
                <div class="card bg-light mb-3">
                    <div class="card-header">
                        <li class="fas fa-lock"><strong>Consultas seguras con php a mysql</strong></li>
                    </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
    ...
    <!--Inicio de modal de insercion-->
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalInsertar" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Insertar datos.</h5>
    ...
    <!--Inicio de modal de actualizacion-->
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalActualizar" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Verificacion de accion.</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                    </div>
